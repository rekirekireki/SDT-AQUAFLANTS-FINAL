...
INSERT INTO `planttbl` (`plantID`, `plantType`, `gardenSize`, `plantName`, `plantDes`, `plantSoil`, `plantSun`, `plantWater`, `Photo`, `plantStatus`) VALUES
(35, 'sada', 'sada', 'sada', 'sada', 'Loamy', 'partial-sun', 'moderate', '15632.jpg', 0);
...
(8, 'sad', 'asdasda', 'lala123', 'kyledelapena45@gmail.com', '123123');
...
INSERT INTO `userevents` (`eventID`, `plantID`, `userID`, `start_Date`, `end_date`, `description`, `plantImg`, `eventName`, `watered`, `sunlight`) VALUES
(10, 0, 2, '2023-05-10 19:20:00.000000', '2023-05-10 19:20:00.000000', 'ASDADDADD', 'Plants/645b7e1df3256.png', 'ASDADADDA', 'Water Received', 'Sunlight Received');
...
--
ALTER TABLE `planttbl`
  MODIFY `plantID` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
